<html>
    ...
    ?>
		<div class="x_panel">
 <div class="x_title">
    <h3 class="panel-title"><b>Daftar Harga Pokok Penjualan Toko</b></h3>
  </div>
  	 <div class="x_content">
  	 		<form class = 'form-inline' method = "POST" class = "form-inline" action = "<?php echo site_url().'/c_keuangan/hpp_toko';?>">
				<label>Produk</label>
...
<p>
  	 ...
  	 Harga Pokok Penjualan <?php echo $nama_produk ?>
