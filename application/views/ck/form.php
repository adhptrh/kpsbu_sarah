<html>
 ...
 <div class="x_title">
	...
	<button type="submit" class="btn btn-dark" <?php if($cek_lulus >= 140000){?> disabled="disabled" <?php }?>>Tambah</button>
		...
		<a class="btn btn-info" role="button" <?php if($cek_lulus >= 1){?> href = "<?php echo site_url()."/c_transaksi/selesai_ck/$id"?>" <?php }else{ ?> disabled="disabled" <?php }?>>Selesai Pengecekan</a>
	</center>
<hr>
